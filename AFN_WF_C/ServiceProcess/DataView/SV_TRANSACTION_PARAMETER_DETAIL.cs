...
namespace AFN_WF_C.ServiceProcess.DataView
{
    class SV_TRANSACTION_PARAMETER_DETAIL
    {
        ...
        private C.GENERIC_VALUE _PARAMETER;
        ...
        private C.GENERIC_VALUE PARAMETER { get { return _PARAMETER; } }
            ...
            return new SV_TRANSACTION_PARAMETER_DETAIL()
                {
                    ...
                    _PARAMETER = od.PARAMETER
                };
        }
        public static implicit operator C.PARAM_VALUE(SV_TRANSACTION_PARAMETER_DETAIL sv)
        {
